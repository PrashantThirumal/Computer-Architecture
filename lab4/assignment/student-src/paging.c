...
uint8_t mem_access(vaddr_t address, char rw, uint8_t data)
{
    ...
    pte_t *page_table_entry = (pte_t *)(page_table + vpn);
    ...
    pfn_t page_frame_num = page_table_entry->pfn;
    ...
    */
    ...
    paddr_t pa = (paddr_t)((page_table_entry->pfn << OFFSET_LEN) | offset);
    ...
    {
        stats.writes++;
        // Save the data to the physical address
        mem[pa] = data;
        page_table_entry->dirty = 1; // Set dirty bit fot writeback
    }
    return data;
}
